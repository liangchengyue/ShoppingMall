...
<head>
    ...
    <title>后台管理</title>
    <link href="../resource/bootstrap/bootstrap.min.css?v=3.3.5" rel="stylesheet">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">
                &copy; 2017-2018 大学生助学贷款网
            </div>
        </div>
    </div>
</div>
<script src="../resource/jquery/jquery.min.js?v=2.1.4"></script>
<script src="../resource/bootstrap/bootstrap.min.js?v=3.3.5"></script>
...
<script src="../resource/h/hplus.min.js?v=4.0.0"></script>
<script type="text/javascript" src="../resource/h/contabs.min.js"></script>
